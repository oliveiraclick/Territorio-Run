  ...
  const features = [
    {
      ...
      description: 'Transforme suas corridas em conquistas reais'
    },
    {
    ...
    },
    {
      ...
      description: 'Métricas em tempo real de cada corrida'
    },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-blue-50 to-cyan-50 flex">
        ...
        <div className="relative z-20 flex flex-col justify-center items-start p-16 text-white">
          ...
          <div className="space-y-6 max-w-md">
            <h2 className="text-3xl font-bold leading-tight">
              Transforme suas corridas em conquistas épicas
            </h2>
            <p className="text-lg opacity-90">
              Cada passo é um território. Cada corrida é uma vitória.
            </p>
          </div>
        </div>
      </div>
